...
const postSchema = new mongoose_1.default.Schema({
    ...
    campaign: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "Campaign", required: false },
    admin: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "Admin", required: false },
    ...
    platform: { type: String, required: true, default: "facebook", enum: ["facebook", "instagram", "twitter", "linkedin", "youtube"] },
